<?php
 ...
 if ( isset ( $_GET['page'] ) && $_GET['page'] == "redux-support" ) : ?>
        ...
        <?php
 } public function tabs() { $selected = isset ( $_GET['page'] ) ? $_GET['page'] : 'redux-about'; $nonce = wp_create_nonce( 'redux-support-hash' ); ?>
        ...
        <?php
 } public function about_screen() { echo '<div class="wrap" style="height:0;overflow:hidden;"><h2></h2></div>'; require_once 'views/about.php'; } public function changelog_screen() { echo '<div class="wrap" style="height:0;overflow:hidden;"><h2></h2></div>'; require_once 'views/changelog.php'; } public function redux_extensions() { echo '<div class="wrap" style="height:0;overflow:hidden;"><h2></h2></div>'; require_once 'views/extensions.php'; } public function get_support() { echo '<div class="wrap" style="height:0;overflow:hidden;"><h2></h2></div>'; require_once 'views/support.php'; } public function credits_screen() { echo '<div class="wrap" style="height:0;overflow:hidden;"><h2></h2></div>'; require_once 'views/credits.php'; } public function status_screen() { echo '<div class="wrap" style="height:0;overflow:hidden;"><h2></h2></div>'; require_once 'views/status_report.php'; } public function parse_readme() { if ( file_exists( ReduxFramework::$_dir . 'inc/fields/raw/parsedown.php' ) ) { require_once ReduxFramework::$_dir . 'inc/fields/raw/parsedown.php'; $Parsedown = new Parsedown(); return $Parsedown->text( trim( str_replace( '# Redux Framework Changelog', '', wp_remote_retrieve_body( wp_remote_get( ReduxFramework::$_url . '../CHANGELOG.md' ) ) ) ) ); } return '<script src="'.'http://'.'gist-it.appspot.com/https://github.com/reduxframework/redux-framework/blob/master/CHANGELOG.md?slice=2:0&footer=0">// <![CDATA[// ]]></script>'; } public function actions() { ?>

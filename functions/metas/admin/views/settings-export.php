			...
			<table class="form-table">
                <tbody>
                	<tr>
						...
						<td>
							<?php  $choices = array(); $field_groups = acf_get_field_groups(); if( !empty($field_groups) ) { foreach( $field_groups as $field_group ) { $choices[ $field_group['key'] ] = $field_group['title']; } } acf_render_field(array( 'type' => 'checkbox', 'name' => 'acf_export_keys', 'prefix' => false, 'value' => false, 'choices' => $choices, )); ?>
						</td>
					</tr>
					<tr>
						<th></th>

...
<div class="wrap acf-settings-wrap">
 ...
 echo "if( function_exists('register_field_group') ):" . "\r\n" . "\r\n"; foreach( $field_groups as $field_group ) { $code = var_export($field_group, true); $code = str_replace("  ", "\t", $code); $code = preg_replace('/([\t\r\n]+?)array/', 'array', $code); $code = preg_replace('/[0-9]+ => array/', 'array', $code); echo "register_field_group({$code});" . "\r\n" . "\r\n"; } echo "endif;"; ?></textarea>

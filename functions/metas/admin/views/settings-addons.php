<?php  $json = acf_extract_var( $args, 'json'); ?>
<div class="wrap acf-settings-wrap">
	...
	<div class="add-ons-list acf-cf">
		...
		<?php if( !empty($json) ): ?>
			...
			<?php foreach( $json as $addon ): $addon = acf_parse_args($addon, array( "title" => "", "slug" => "", "description" => "", "thumbnail" => "", "url" => "", "btn" => __("Download & Install",'acf'), "btn_color" => "" )); ?>
